// grabbing-action.js v2.1.0 - 2026-09-09
// v2.1.0: Fix dialog ballooning to full width on checkbox/select
...
//         the dialog root so every control (including the CS toggles)
